        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValueTier = table.Column<string>(type: "TEXT", nullable: false),
                    AssignedRepId = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonitoringConsent = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActiveTimeRatio = table.Column<double>(type: "REAL", nullable: false),
                    ProductiveAppUsage = table.Column<double>(type: "REAL", nullable: false),
                    KeyboardIntensity = table.Column<double>(type: "REAL", nullable: false),
                    TaskCompletionRate = table.Column<double>(type: "REAL", nullable: false),
                    FinalScore = table.Column<double>(type: "REAL", nullable: false),
                    ManualAdjustment = table.Column<int>(type: "INTEGER", nullable: false),
                    AdjustmentNote = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductivityScores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductivityScores_Employees_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InteractionLogs_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductivityScores_EmployeeId",
                table: "ProductivityScores",
                column: "EmployeeId");
